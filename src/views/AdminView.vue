...
export default {
  ...
  computed: {
    ...
    currentUserIsAdmin() {
      if (this.currentUserEmail === 'minho7571@gmail.com') return true;
    ...
    currentUserRoleLevel() {
      ...
      if (this.currentUserEmail === 'minho7571@gmail.com') {
  ...
  methods: {
    ...
    async changeUserType(member) {
      try {
        ...
        if (member.email === 'minho7571@gmail.com') {
